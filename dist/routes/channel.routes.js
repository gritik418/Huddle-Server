...
import { createChannel, deleteChannel, getAllChannels, getChannelById, getChannelChats, getChannelMessages, getCreatedChannels, getJoinedChannels, getUserChannels, leaveChannel, removeMemberFromChannel, } from "../controllers/channelController.js";
const router = Router();
...
router.delete("/:channelId/remove/:memberId", authenticate, removeMemberFromChannel);
