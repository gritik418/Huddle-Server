...
export const getOwnStories = async (req, res) => {
    try {
        ...
        const user = await User.findById(userId).select("_id firstName lastName username profilePicture");
        if (!user) {
...
export const deleteStory = async (req, res) => {
    try {
        ...
        if (story.mediaUrl) {
            const filePath = path.join(__dirname, "../../public", story?.mediaUrl.replace(/^.*\/uploads/, "uploads"));
