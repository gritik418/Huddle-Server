                            ...
                            <tr>
                              <td style="width:138px;">
                                <a href="${
                                  ...
                                  <img alt="" title="" height="98px" src="${
                                    process.env.BASE_URL
                                  }/images/logo-vertical.png" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:64px;" width="138">
                                </a>
                              </td>
                            </tr>
                          </tbody>
          ...
          <tbody>
            <tr>
              <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;ʼ’:0px;">
                <p><img src="${
                  process.env.BASE_URL
                }/images/verify-email.png" alt="img" title="None" style="height: auto;width: 90%;max-width: 500px;"></p>
                <div aria-labelledby="mj-column-per-100" class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;">
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tbody>
                      <tr>
